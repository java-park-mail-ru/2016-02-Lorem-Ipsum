CREATE DATABASE  IF NOT EXISTS `dbjava` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dbjava`;
...
CREATE TABLE `users` (
  ...
  PRIMARY KEY (`id`),
  KEY `loginIndex` (`login`(10)),
  KEY `emailIndex` (`email`(10))
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-03-25 20:52:46
