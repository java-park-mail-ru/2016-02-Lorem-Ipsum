 ...
 */
public class OutputMessageDisconnect extends MessageGame {

    private final GameSession gameSession;

    public OutputMessageDisconnect(
            Address from,
            Address to,
    ...
    protected void execInternal(GameMessageProcessor processor) throws GameException {
        JSONObject toSend = OutputJSONMessagesCreator.getMessageToStop(gameSession);
